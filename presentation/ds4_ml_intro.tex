...
%%\author{Milan Cugurovic \\ \texttt{contact information on next slide}}
...
\end{frame}
% -------------------------------------------------------------------------------------------------
%%\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{images/math.JPG}} 
\begin{frame}{But why is it so successful and popular today?}
    \begin{itemize}
